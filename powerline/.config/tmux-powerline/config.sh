...
# claude_code.sh {
	...
	# export TMUX_POWERLINE_SEG_CLAUDE_CODE_CREDENTIALS_FILE="/Users/winstont/.claude/.credentials.json"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/winstont/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/winstont/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/winstont/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/winstont/.local/share/tmux/plugins/tmux-continuum"
# }
...
# weather.sh {
	...
	#   rm "/var/folders/l3/4pp3hyvd45j754sty9dscqsc0000gn/T//tmux-powerline/weather_cache_data.txt"
